  ...
  options: [
    ...
    },
    {
      ...
      options: [
        {
          value: "inset-px",
          label: "『 inset-px 』 top: 1px; right: 1px; bottom: 1px; left: 1px;"
        },
        {
          value: "inset-x-px",
    ...
    },
    {
      ...
      options: [
        {
          value: "inset-1/2",
          label: "『 inset-1/2 』 top: 50%; right: 50%; bottom: 50%; left: 50%;"
        },
        {
          value: "inset-x-1/2",
    ...
    },
    {
      ...
      options: [
        {
          value: "inset-1/4",
          label: "『 inset-1/4 』 top: 25%; right: 25%; bottom: 25%; left: 25%;"
        },
        {
          value: "inset-x-1/4",
    ...
    },
    {
      ...
      options: [
        {
          value: "inset-2/4",
          label: "『 inset-2/4 』 top: 50%; right: 50%; bottom: 50%; left: 50%;"
        },
        {
          value: "inset-x-2/4",
    ...
    },
    {
      ...
      options: [
        {
          value: "inset-3/4",
          label: "『 inset-3/4 』 top: 75%; right: 75%; bottom: 75%; left: 75%;"
        },
        {
          value: "inset-x-3/4",
