...
const AttributeArea: FC<AttributeProps> = forwardRef(({ className, attrs, callback }, nodeRef: ForwardedRef<HTMLDivElement>) => {
      ...
      {attrs?.id && (
        <Fragment>
          ...
          <div className="rounded-lg bg-gray-1100 px-2 pb-2 dark:bg-purple-1100">
            <div className="flex items-center py-3">
              <Icon name="tailwindcss" className="h-6 w-6 text-sky-400" />
              <span className="pl-2.5 text-lg font-semibold text-gray-1200 dark:text-purple-1200">tailwindcss 样式</span>
            </div>
            ...
            <div className="flex-1">
              ...
              >
                {attributes.map(attr => (
                  <Panel key={attr.type} header={attr.header} className="site-collapse-custom-panel truncate">
                    <Attribute
                      title={attr.title}
                      type={attr.type}
          ...
          <div className="mt-2 rounded-lg bg-gray-1100 px-2 pb-2 dark:bg-purple-1100">
            <div className="flex items-center py-3">
              ...
              <div className="flex flex-1 items-center justify-between">
                <span className="pl-2.5 text-lg font-semibold text-gray-1200 dark:text-purple-1200">添加自定义属性</span>
                <Button type="link" icon={<PlusCircleOutlined />} className="p-0 text-lg" title="添加属性" />
              </div>
            </div>
            ...
            <div className="min-h-[80px]">
              <div className="flex flex-col items-center py-4">
                ...
                <span className="block pt-2 text-sm text-gray-1200/50 dark:text-purple-1200">暂无自定义属性</span>
              </div>
            </div>
          </div>
        </Fragment>
